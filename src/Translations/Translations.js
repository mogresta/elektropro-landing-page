const translations = {
    hr: {
        ...
        experience: {
            ...
            projectCountries: 'Projekti u zemljama:',
        ...
        email: {
            inquiry: {
                subject: 'Upit za elektroinstalacije',
                body: 'Pozdrav,%0D%0A%0D%0AMolim procjenu za:%0D%0A- Vrsta objekta:%0D%0A- Lokacija:%0D%0A- Opis posla:%0D%0A%0D%0AHvala!'
            },
            estimate: {
                subject: 'Zahtjev za procjenu'
            }
        },
        finalCta: {
    ...
    en: {
        ...
        experience: {
            ...
            projectCountries: 'Projects in countries:',
            ...
            countries: [
                "Croatia", "Germany", "Netherlands", "Belgium", "Luxembourg", "Italy"
            ],
        },
        references: {
            title: 'References and experience',
        ...
        email: {
            inquiry: {
                subject: 'Inquiry for electrical installations',
                body: 'Hello,%0D%0A%0D%0AI would like a quote for:%0D%0A- Property type:%0D%0A- Location:%0D%0A- Job description:%0D%0A%0D%0AThank you!'
            },
            estimate: {
